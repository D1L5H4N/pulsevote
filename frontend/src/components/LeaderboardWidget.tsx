        ...
        <div className="flex items-center justify-between gap-3 mb-5">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h3 className="font-semibold text-white text-sm whitespace-nowrap tracking-tight">Popular Polls</h3>
              <p className="text-xs text-slate-400 truncate">Performance leaderboard</p>
            </div>
          </div>

          {/* Tabs */}
          <div className="h-8 inline-flex items-center gap-0.5 bg-slate-950/80 p-0.5 rounded-lg border border-slate-800 text-[11px] shrink-0">
            <button
